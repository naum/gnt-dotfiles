" Vim color file
" Converted from Textmate theme Why’s Poignant using Coloration v0.2.4 (http://github.com/sickill/coloration)
...
if exists("syntax_on")
  ...
  let g:colors_name = "why_poignant"

  hi Cursor  guifg=NONE guibg=#e8f5f5 gui=NONE
